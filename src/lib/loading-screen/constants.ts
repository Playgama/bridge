...
export interface ProgressLogoPathItem {
    d: string
    fillRule?: string
    maskFill?: string
}

export interface ProgressLogoPreset {
    viewBox: string
...
export const LOADING_SCREEN_OVERLAY_ID = 'loading-overlay'
export const LOADING_SCREEN_LOGO_ID = 'logo'
export const LOADING_SCREEN_FILL_RECT_ID = 'fillRect'
...
export const LOADING_SCREEN_FULL_BRIDGE_PRESET: ProgressLogoPreset = {
    viewBox: '0 0 633 986',
    paths: [
...
export const LOADING_SCREEN_HINTS = [
    'Loading GPU',
    'Parsing AST',
    'Linking libs',
    'Baking mesh',
