...
import type { EventEmitter, SafeArea } from '../types/common'
...
export interface DeviceBridgeContract extends PlatformBridgeLike {
...
class DeviceModule extends ModuleBase<DeviceBridgeContract> {
    get type(): DeviceType {
    ...
    #supportedOrientations: DeviceOrientation[] | null = null
    ...
    #initializeOrientationOverlay(): void {
    ...
    #updateOverlay(): void {
        ...
        if (!this.#supportedOrientations || this.#supportedOrientations.length !== 1) {
            this.#hideOverlay()
            return
        }
    ...
    #initializeScreenSizeTracking(): void {
