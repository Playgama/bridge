...
export const POST_REWARD_TYPE = socialConstants.POST_REWARD_TYPE
export type POST_REWARD_TYPE = socialConstants.PostRewardType
...
export type { PostRewardType } from './modules/social/constants'
